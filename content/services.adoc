...
Support for the following situations:

* opensource packages that have bugs which you need fixed
* opensource packages that are insufficiently documented
* other types of require maintenance
